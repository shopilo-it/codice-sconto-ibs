#!/usr/bin/env python3
"""
Recupero codici sconto IBS da shopilo.it
Sursa: https://shopilo.it/negozi/ibs.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/ibs.it"
STORE_NAME = "IBS"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per IBS da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-ibs)"
    }
    try:
